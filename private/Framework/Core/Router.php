...
class Router
{
     ...
     * @return void
     */
    public function add($namespaces)
    {
        //add namespase  void ////
    $namespaces[]="";
    ...
    public function match($url)
    {
        ...
        foreach ($this->routes as $route ) {
            if (preg_match($route, $url, $matches)) {
                ...
                isset($this->params["controller"])&&!empty($this->params["controller"])?: $this->params["controller"] = "Index";
                isset($this->params["action"])&&!empty($this->params["action"]) ?: $this->params["action"] = "index";
